    ...
    <div className="nearby-sec">
      <div className="container">
        <div className="w-full text-center">
          <h3>{t("Near By Charging Station")}</h3>
        </div>
        <div id="splide-near" className="splide -mx-[15px]">
          <div className="splide__track">
            <ul className="splide__list">
              {entities.prop.response.entities ? (
                <>
                  {entities.prop.response.entities.map((i: any) => {
                    return (
                      <>
                        <li className="splide__slide">
                          <div className="near-location">
                            ...
                            <div className=" komal store-address">
                              <svg
...
export default withTranslation()(NearBy);
